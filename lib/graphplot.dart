...
class GraphPlay extends StatefulWidget {
  @override
  _GraphPlayState createState() => _GraphPlayState();
}
      ...
      child: Stack(
        children: [
          CustomPaint(
            ...
            child: Container(height: 200.0, color: Colors.white10),
          ),
          Positioned(
          ...
          CustomPaint(
            painter: GraphPaint(controller.value),
            child: Container(height: 100.0, color: Colors.white10),
          ),
          Positioned(
